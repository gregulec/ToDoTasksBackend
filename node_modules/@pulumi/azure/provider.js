...
class Provider extends pulumi.ProviderResource {
    ...
    constructor(name, args, opts) {
        ...
        opts = opts || {};
        {
            ...
            inputs["environment"] = (_a = (args ? args.environment : undefined), (_a !== null && _a !== void 0 ? _a : (utilities.getEnv("AZURE_ENVIRONMENT", "ARM_ENVIRONMENT") || "public")));
            inputs["features"] = pulumi.output(args ? args.features : undefined).apply(JSON.stringify);
            inputs["metadataHost"] = (_b = (args ? args.metadataHost : undefined), (_b !== null && _b !== void 0 ? _b : utilities.getEnv("ARM_METADATA_HOSTNAME")));
            inputs["metadataUrl"] = (_c = (args ? args.metadataUrl : undefined), (_c !== null && _c !== void 0 ? _c : utilities.getEnv("ARM_METADATA_URL")));
            ...
            inputs["skipProviderRegistration"] = pulumi.output((_d = (args ? args.skipProviderRegistration : undefined), (_d !== null && _d !== void 0 ? _d : (utilities.getEnvBoolean("ARM_SKIP_PROVIDER_REGISTRATION") || false)))).apply(JSON.stringify);
            inputs["storageUseAzuread"] = pulumi.output((_e = (args ? args.storageUseAzuread : undefined), (_e !== null && _e !== void 0 ? _e : (utilities.getEnvBoolean("ARM_STORAGE_USE_AZUREAD") || false)))).apply(JSON.stringify);
            inputs["subscriptionId"] = (_f = (args ? args.subscriptionId : undefined), (_f !== null && _f !== void 0 ? _f : (utilities.getEnv("ARM_SUBSCRIPTION_ID") || "")));
