...
// Export members:
__export(require("./advancedThreatProtection"));
__export(require("./assessment"));
__export(require("./assessmentMetadata"));
__export(require("./assessmentPolicy"));
__export(require("./autoProvisioning"));
__export(require("./automation"));
__export(require("./contact"));
__export(require("./serverVulnerabilityAssessment"));
__export(require("./setting"));
__export(require("./subscriptionPricing"));
