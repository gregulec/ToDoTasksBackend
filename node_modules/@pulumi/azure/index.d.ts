...
export { advisor, analysisservices, apimanagement, appconfiguration, appinsights, appplatform, appservice, attestation, authorization, automation, avs, backup, batch, billing, blueprint, bot, cdn, cognitive, communication, compute, config, consumption, containerservice, core, cosmosdb, costmanagement, dashboard, databasemigration, databoxedge, databricks, datafactory, datalake, dataprotection, datashare, desktopvirtualization, devspace, devtest, digitaltwins, dns, domainservices, eventgrid, eventhub, frontdoor, hdinsight, healthcare, hpc, hsm, iot, iotcentral, keyvault, kusto, lb, lighthouse, loganalytics, logicapps, machinelearning, maintenance, managedapplication, management, managementgroups, managementresource, maps, mariadb, marketplace, media, mediaservices, mixedreality, monitoring, msi, mssql, mysql, netapp, network, notificationhub, operationalinsights, policy, postgresql, powerbi, privatedns, privatelink, proximity, purview, recoveryservices, redis, relay, role, search, securitycenter, sentinel, servicebus, servicefabric, signalr, siterecovery, sql, stack, storage, streamanalytics, synapse, trafficmanager, types, videoanalyzer, waf, };
