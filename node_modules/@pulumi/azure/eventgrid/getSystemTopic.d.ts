 ...
 */
export declare class GetSystemTopic extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GetSystemTopicState, opts?: pulumi.CustomResourceOptions): GetSystemTopic;
    /**
     * Returns true if the given object is an instance of GetSystemTopic.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is GetSystemTopic;
    /**
