...
class BlobEventSubscription extends appservice.EventSubscription {
    constructor(name, container, args, opts = {}) {
        var _a;
        const resourceGroupName = (_a = args.resourceGroupName, (_a !== null && _a !== void 0 ? _a : resolveResourceGroupName(container)));
...
class QueueEventSubscription extends appservice.EventSubscription {
    constructor(name, queue, args, opts = {}) {
        ...
        const resourceGroupName = (_a = args.resourceGroupName, (_a !== null && _a !== void 0 ? _a : resolveResourceGroupName(queue)));
