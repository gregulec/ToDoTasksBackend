...
class EventHubFunction extends appservice.Function {
    constructor(name, args) {
        ...
        const namespace = pulumi.all([args.eventHub.namespaceName, args.eventHub.resourceGroupName, args.eventHub.id])
            .apply(([namespaceName, resourceGroupName]) => _2.getEventhubNamespace({ name: namespaceName, resourceGroupName }));
...
exports.QueueEventSubscription = servicebus_1.QueueEventSubscription;
exports.ServiceBusFunction = servicebus_1.ServiceBusFunction;
exports.TopicEventSubscription = servicebus_1.TopicEventSubscription;
...
exports.EventGridFunction = eventgrid_1.EventGridFunction;
exports.EventGridCallbackSubscription = eventgrid_1.EventGridCallbackSubscription;
/**
