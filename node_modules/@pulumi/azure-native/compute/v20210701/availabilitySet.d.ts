...
export declare class AvailabilitySet extends pulumi.CustomResource {
     ...
     */
    readonly statuses: pulumi.Output<outputs.compute.v20210701.InstanceViewStatusResponse[]>;
    /**
     * Resource tags
     */
     ...
     */
    readonly virtualMachines: pulumi.Output<outputs.compute.v20210701.SubResourceResponse[] | undefined>;
    /**
...
export interface AvailabilitySetArgs {
     ...
     * A list of references to all virtual machines in the availability set.
     */
    virtualMachines?: pulumi.Input<pulumi.Input<inputs.compute.v20210701.SubResourceArgs>[]>;
}
