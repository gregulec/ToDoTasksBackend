...
export declare class CapacityReservationGroup extends pulumi.CustomResource {
     ...
     */
    readonly capacityReservations: pulumi.Output<outputs.compute.v20210401.SubResourceReadOnlyResponse[]>;
    /**
     * The capacity reservation group instance view which has the list of instance views for all the capacity reservations that belong to the capacity reservation group.
     */
    readonly instanceView: pulumi.Output<outputs.compute.v20210401.CapacityReservationGroupInstanceViewResponse>;
    /**
     * Resource location
     */
     ...
     */
    readonly virtualMachinesAssociated: pulumi.Output<outputs.compute.v20210401.SubResourceReadOnlyResponse[]>;
    /**
