...
export interface ExpressRouteGatewayArgs {
     ...
     * Configuration for auto scaling.
     */
    autoScaleConfiguration?: pulumi.Input<inputs.network.v20210201.ExpressRouteGatewayPropertiesAutoScaleConfigurationArgs>;
    /**
     ...
     * The Virtual Hub where the ExpressRoute gateway is or will be deployed.
     */
    virtualHub: pulumi.Input<inputs.network.v20210201.VirtualHubIdArgs>;
}
