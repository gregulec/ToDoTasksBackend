...
exports.FormulaResource = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
/**
 * A formula.
 */
class FormulaResource extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new FormulaResource(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.FormulaResource = FormulaResource;
/** @internal */
FormulaResource.__pulumiType = 'azure-native:devtestlab/v20150521preview:FormulaResource';
//# sourceMappingURL=formulaResource.js.map