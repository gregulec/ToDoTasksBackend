export declare const ContainerServiceOchestratorTypes: {
    readonly Mesos: "Mesos";
    readonly SwarmPreview: "SwarmPreview";
    readonly DCOS: "DCOS";
};
/**
 * Specifies what orchestrator will be used to manage container cluster resources.
 */
export declare type ContainerServiceOchestratorTypes = (typeof ContainerServiceOchestratorTypes)[keyof typeof ContainerServiceOchestratorTypes];
 ...
 * Size of agent VMs
 */
export declare type ContainerServiceVMSizeTypes = (typeof ContainerServiceVMSizeTypes)[keyof typeof ContainerServiceVMSizeTypes];
