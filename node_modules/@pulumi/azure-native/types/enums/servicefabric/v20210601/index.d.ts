...
export declare const NotificationCategory: {
     ...
     */
    readonly WaveProgress: "WaveProgress";
};
/**
 * The category of notification.
 */
export declare type NotificationCategory = (typeof NotificationCategory)[keyof typeof NotificationCategory];
export declare const NotificationChannel: {
     ...
     */
    readonly EmailSubscription: "EmailSubscription";
};
/**
 * The notification channel indicates the type of receivers subscribed to the notification, either user or subscription.
 */
export declare type NotificationChannel = (typeof NotificationChannel)[keyof typeof NotificationChannel];
 ...
 */
export declare type NotificationLevel = (typeof NotificationLevel)[keyof typeof NotificationLevel];
...
export declare const SfZonalUpgradeMode: {
    /**
 ...
 */
export declare type SfZonalUpgradeMode = (typeof SfZonalUpgradeMode)[keyof typeof SfZonalUpgradeMode];
...
export declare const VmssZonalUpgradeMode: {
    /**
 ...
 */
export declare type VmssZonalUpgradeMode = (typeof VmssZonalUpgradeMode)[keyof typeof VmssZonalUpgradeMode];
