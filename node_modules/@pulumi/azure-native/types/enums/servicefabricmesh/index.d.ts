 ...
 */
export declare type ApplicationScopedVolumeKind = (typeof ApplicationScopedVolumeKind)[keyof typeof ApplicationScopedVolumeKind];
 ...
 */
export declare type AutoScalingMechanismKind = (typeof AutoScalingMechanismKind)[keyof typeof AutoScalingMechanismKind];
 ...
 */
export declare type AutoScalingMetricKind = (typeof AutoScalingMetricKind)[keyof typeof AutoScalingMetricKind];
 ...
 */
export declare type AutoScalingResourceMetricName = (typeof AutoScalingResourceMetricName)[keyof typeof AutoScalingResourceMetricName];
 ...
 */
export declare type AutoScalingTriggerKind = (typeof AutoScalingTriggerKind)[keyof typeof AutoScalingTriggerKind];
 ...
 */
export declare type HeaderMatchType = (typeof HeaderMatchType)[keyof typeof HeaderMatchType];
 ...
 */
export declare type NetworkKind = (typeof NetworkKind)[keyof typeof NetworkKind];
 ...
 */
export declare type PathMatchType = (typeof PathMatchType)[keyof typeof PathMatchType];
 ...
 */
export declare type SecretKind = (typeof SecretKind)[keyof typeof SecretKind];
 ...
 * Volume size
 */
export declare type SizeTypes = (typeof SizeTypes)[keyof typeof SizeTypes];
