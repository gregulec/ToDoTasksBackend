 ...
 */
export declare type CalculationWindowTypes = (typeof CalculationWindowTypes)[keyof typeof CalculationWindowTypes];
 ...
 */
export declare type CardinalityTypes = (typeof CardinalityTypes)[keyof typeof CardinalityTypes];
 ...
 */
export declare type CompletionOperationTypes = (typeof CompletionOperationTypes)[keyof typeof CompletionOperationTypes];
 ...
 * Type of connector.
 */
export declare type ConnectorTypes = (typeof ConnectorTypes)[keyof typeof ConnectorTypes];
 ...
 * Type of entity.
 */
export declare type EntityTypes = (typeof EntityTypes)[keyof typeof EntityTypes];
 ...
 */
export declare type ErrorManagementTypes = (typeof ErrorManagementTypes)[keyof typeof ErrorManagementTypes];
 ...
 */
export declare type FormatTypes = (typeof FormatTypes)[keyof typeof FormatTypes];
 ...
 */
export declare type FrequencyTypes = (typeof FrequencyTypes)[keyof typeof FrequencyTypes];
 ...
 */
export declare type InstanceOperationType = (typeof InstanceOperationType)[keyof typeof InstanceOperationType];
 ...
 */
export declare type KpiFunctions = (typeof KpiFunctions)[keyof typeof KpiFunctions];
 ...
 * Link type.
 */
export declare type LinkTypes = (typeof LinkTypes)[keyof typeof LinkTypes];
