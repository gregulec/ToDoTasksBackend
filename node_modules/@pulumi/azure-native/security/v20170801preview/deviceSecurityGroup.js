...
class DeviceSecurityGroup extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:security/v20170801preview:DeviceSecurityGroup" }, { type: "azure-native:security:DeviceSecurityGroup" }, { type: "azure-nextgen:security:DeviceSecurityGroup" }, { type: "azure-native:security/v20190801:DeviceSecurityGroup" }, { type: "azure-nextgen:security/v20190801:DeviceSecurityGroup" }] };
...
/** @internal */
DeviceSecurityGroup.__pulumiType = 'azure-native:security/v20170801preview:DeviceSecurityGroup';
//# sourceMappingURL=deviceSecurityGroup.js.map