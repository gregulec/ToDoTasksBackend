 ...
 */
export declare class IPSyncer extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IPSyncer;
    /**
     * Returns true if the given object is an instance of IPSyncer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IPSyncer;
    /**
     ...
     */
    readonly kind: pulumi.Output<"IPSyncer">;
    /**
     * Azure resource name
     */
