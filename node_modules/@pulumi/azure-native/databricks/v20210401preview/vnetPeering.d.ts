...
export declare class VNetPeering extends pulumi.CustomResource {
     ...
     */
    readonly databricksAddressSpace: pulumi.Output<outputs.databricks.v20210401preview.AddressSpaceResponse | undefined>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    readonly databricksVirtualNetwork: pulumi.Output<outputs.databricks.v20210401preview.VirtualNetworkPeeringPropertiesFormatResponseDatabricksVirtualNetwork | undefined>;
    /**
     ...
     */
    readonly remoteAddressSpace: pulumi.Output<outputs.databricks.v20210401preview.AddressSpaceResponse | undefined>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    readonly remoteVirtualNetwork: pulumi.Output<outputs.databricks.v20210401preview.VirtualNetworkPeeringPropertiesFormatResponseRemoteVirtualNetwork>;
    /**
...
export interface VNetPeeringArgs {
     ...
     * The reference to the databricks virtual network address space.
     */
    databricksAddressSpace?: pulumi.Input<inputs.databricks.v20210401preview.AddressSpaceArgs>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    databricksVirtualNetwork?: pulumi.Input<inputs.databricks.v20210401preview.VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetworkArgs>;
    /**
     ...
     * The reference to the remote virtual network address space.
     */
    remoteAddressSpace?: pulumi.Input<inputs.databricks.v20210401preview.AddressSpaceArgs>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    remoteVirtualNetwork: pulumi.Input<inputs.databricks.v20210401preview.VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetworkArgs>;
    /**
