...
export interface WebhookArgs {
     ...
     * The list of actions that trigger the webhook to post notifications.
     */
    actions: pulumi.Input<pulumi.Input<string | enums.containerregistry.v20190501.WebhookAction>[]>;
    /**
     ...
     * The status of the webhook at the time the operation was called.
     */
    status?: pulumi.Input<string | enums.containerregistry.v20190501.WebhookStatus>;
    /**
