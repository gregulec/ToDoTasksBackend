...
export declare class Token extends pulumi.CustomResource {
     ...
     */
    readonly credentials: pulumi.Output<outputs.containerregistry.v20210601preview.TokenCredentialsPropertiesResponse | undefined>;
    /**
...
export interface TokenArgs {
     ...
     * The credentials that can be used for authenticating the token.
     */
    credentials?: pulumi.Input<inputs.containerregistry.v20210601preview.TokenCredentialsPropertiesArgs>;
    /**
     ...
     * The status of the token example enabled or disabled.
     */
    status?: pulumi.Input<string | enums.containerregistry.v20210601preview.TokenStatus>;
    /**
