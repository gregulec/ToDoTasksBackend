...
// Export members:
__exportStar(require("./getInstanceDetails"), exports);
...
const instanceDetails_1 = require("./instanceDetails");
const _module = {
    version: utilities.getVersion(),
    construct: (name, type, urn) => {
        switch (type) {
            case "azure-native:dynamics365fraudprotection:InstanceDetails":
                return new instanceDetails_1.InstanceDetails(name, undefined, { urn });
            default:
