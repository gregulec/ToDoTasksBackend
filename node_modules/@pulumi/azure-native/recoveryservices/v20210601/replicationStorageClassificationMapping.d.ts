...
export declare class ReplicationStorageClassificationMapping extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.v20210601.StorageClassificationMappingPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationStorageClassificationMappingArgs {
     ...
     */
    properties?: pulumi.Input<inputs.recoveryservices.v20210601.StorageMappingInputPropertiesArgs>;
    /**
