 ...
 */
export declare class BlobStorageAccountDataSet extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BlobStorageAccountDataSet;
    /**
     ...
     */
    static isInstance(obj: any): obj is BlobStorageAccountDataSet;
    /**
     ...
     */
    readonly kind: pulumi.Output<"BlobStorageAccount">;
    /**
     ...
     */
    readonly paths: pulumi.Output<outputs.datashare.v20201001preview.BlobStorageAccountPathResponse[]>;
    /**
