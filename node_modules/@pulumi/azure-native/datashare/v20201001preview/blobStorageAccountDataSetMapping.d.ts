 ...
 */
export declare class BlobStorageAccountDataSetMapping extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BlobStorageAccountDataSetMapping;
    /**
     ...
     */
    static isInstance(obj: any): obj is BlobStorageAccountDataSetMapping;
    /**
